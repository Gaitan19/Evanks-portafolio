...
export const dataPortfolio = [
  {
    ...
    image: "/events-1.png",
    description: "Enterprise-grade event management solution featuring real-time synchronization between a Next.js dashboard and ASP.NET Core REST API, handling 50k+ monthly registrations.",
  ...
  },
  {
    ...
    description: "Secure REST API for enterprise asset management, implementing JWT authentication and handling 1M+ monthly transactions with EF Core optimizations.",
  ...
  },
  {
    ...
    description: "Full-stack library management platform reducing book retrieval time by 65% through advanced search algorithms and TypeScript type safety.",
    technologies: ["Next.js", "TypeScript", "Tailwind", ".NET", "SQL Server"],
  ...
  },
  {
    ...
    image: "/marvel-1.png",
    description: "Interactive Marvel encyclopedia featuring 10k+ characters with dynamic content loading and responsive design achieving 95+ Lighthouse score.",
  ...
  },
  {
    ...
    title: "Pokédex Pro",
    image: "/pokemon-1.png",
    description: "Advanced Pokémon database with GraphQL integration and Redux state management, serving 1k+ daily users with 98% cache hit ratio.",
