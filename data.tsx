...
export const dataPortfolio = [
  {
    ...
    image: "/events-1.png",
    description: "This platform streamlines event planning with a centralized dashboard, managing organizers, participants, sponsors, and real-time registration tracking.",
  ...
  },
  {
    ...
    description: "High-performance food ordering system with real-time order tracking, reducing checkout time by 40% through optimized Next.js SSR implementation.",
  ...
  },
  {
    ...
    description: "Robust API for managing inventory loans, enabling users to request items, track availability, handle returns, and oversee approval workflows with secure access and detailed inventory movement logs.",
  ...
  },
  {
    ...
    description: "Comprehensive system for managing books, users, and loans with borrowing limits, availability filters, and intuitive modals, offering a smooth and responsive user experience with real-time feedback.",
    technologies: ["Next.js", "TypeScript", "Tailwind", ".NET", "SQL Server"],
  ...
  },
  {
    ...
    image: "/marvel-1.png",
    description: "This static web app, built with Bootstrap and CSS, provides Marvel Cinematic Universe content with multiple pages and dynamic JavaScript integration.",
  ...
  },
  {
    ...
    title: "Pokédex Pro",
    image: "/pokemon-1.png",
    description: "Interactive web app that allows users to explore a complete Pokémon database, including detailed listings for creatures, items, and moves, with powerful search, filtering, and favorites management.",
  ...
  },
  {
    ...
    description: "Enterprise lending platform featuring role-based access control and real-time analytics dashboard, reducing processing time by 30% through React Query optimizations.",
  ...
  },
  {
    ...
    image: "/todo-1.png",
    description: "Secure task management system with JWT authentication and offline-first capabilities, achieving 99.9% uptime through Next.js ISR implementation.",
