...
const Navbar = () => {
  return (
    <nav
      className="fixed z-20 flex flex-col items-center w-auto 
    mt-auto justify-center h-max bottom-20 left-1/2 transform -translate-x-1/2 tracking-wide backdrop-blur-md "
    >
      <div
